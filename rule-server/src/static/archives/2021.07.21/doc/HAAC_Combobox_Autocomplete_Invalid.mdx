...
Note, example code includes material copied from or derived from [W3C, ARIA 1.2 Authoring practices](https://www.w3.org/TR/wai-aria-practices-1.2/examples/combobox/aria1.1pattern/listbox-combo.html). Copyright © [2013-2017] W3C® (MIT, ERCIM, Keio, Beihang).
