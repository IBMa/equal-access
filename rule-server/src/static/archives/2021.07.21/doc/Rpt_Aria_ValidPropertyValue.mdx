...
The attribute value specified on the element must be valid per WAI-ARIA 1.2 specification
...
* Provide a valid value for the attribute defined on the element, using the WAI-ARIA 1.2 specification as a guide.
