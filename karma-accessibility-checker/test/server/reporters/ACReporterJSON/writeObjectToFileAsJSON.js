...
/*******************************************************************************
 * NAME: writeObjectToFileAsJSON.js
...
test('writeObjectToFileAsJSON(fileName, content) should write JSON object to a file', function (ava) {
...
test('writeObjectToFileAsJSON(fileName, content) should write JSON object to a file based on hierarchy', function (ava) {
