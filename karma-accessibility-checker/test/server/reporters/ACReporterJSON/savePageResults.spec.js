...
describe("ACReporterJSON.savePageResults", function () {
    ...
    it('savePageResults(config, results) should save the scan results to a file', function (done) {
    ...
    it('savePageResults(config, results) should save the scan results to a file based on hierarchy', function (done) {
