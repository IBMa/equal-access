...
test('addToSummaryCount(pageCount) should add scan summary count to ACReporterCommon.scanSummary.counts', function (ava) {
    ...
    ava.deepEqual(ACReporterCommon.scanSummary.counts, unitTestCommon.scanPageOutput.summary.counts);
});

test('addToSummaryCount(pageCount) should update scan summary count at ACReporterCommon.scanSummary.counts', function (ava) {
    ...
    ava.deepEqual(ACReporterCommon.scanSummary.counts, scanSummaryCount);
});
