...
test('initializeSummary(config) should return initialized scan summary object based on mock config object', function (ava) {
    ...
    ava.deepEqual(scanSummary, unitTestCommon.expectScanSummary);
});

test('initializeSummary(config) should return initialized scan summary object based on mock config object with counts populated by default values', function (ava) {
...
test('initializeSummary(config) should return initialized scan summary object based on mock config object with counts populated with some violations levels', function (ava) {
    // Remove reportLevels from the ACConfig object to verify that init is able to populate it automatically.
