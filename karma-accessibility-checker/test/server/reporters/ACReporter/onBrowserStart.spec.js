...
describe("ACReporter.onBrowserStart", function() {
    ...
    it('onBrowserStart(browser) should log information on browser start for debug', function(done) {
