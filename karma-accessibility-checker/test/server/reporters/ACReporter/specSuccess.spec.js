...
/*******************************************************************************
 * NAME: specSuccess.spec.js
 * DESCRIPTION: Used to test the specSuccess function in
 *              ACReporter.js
...
describe("ACReporter.specSuccess", function() {
    ...
    it('specSuccess(browser, result) should log information on browser start for debug', function(done) {
        ...
        // Call the specSuccess function to identify that the test was successful
