...
/*******************************************************************************
 * NAME: getTravisCIEnvironmentVariables.js
...
test('getTravisCIEnvironmentVariables() should read and return TRAVIS CI environments (all empty)', function (ava) {
    ...
    ava.deepEqual(travisCIEnvironmentVariables, expectedtravisCIEnvironmentVariables);
});

test('getTravisCIEnvironmentVariables() should read and return TRAVIS CI environments (all filled)', function (ava) {
