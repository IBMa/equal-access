...
test('getCommitAuthorName() should return commit author\'s name', function (ava) {
    ...
    ava.not(COMMITER_NAME, "UNKNOWN");
});

test('getCommitAuthorName() should return UNKNOWN when git command does not exist', function (ava) {
    ...
    ava.is(COMMITER_NAME, "UNKNOWN");
});

test('getCommitAuthorName() should return UNKNOWN when .git folder does not exist in current directory', function (ava) {
