...
/*******************************************************************************
 * NAME: getViolationMappingToHumanReadable.js
...
test('getViolationMappingToHumanReadable(violationType) should return "Violations"', function (ava) {
    ...
    ava.is(attachmentsFieldsForViolations, expectedHumanReadableViolationType);
});

test('getViolationMappingToHumanReadable(violationType) should return "Potential Violations"', function (ava) {
...
test('getViolationMappingToHumanReadable(violationType) should return "Recommendations"', function (ava) {
...
test('getViolationMappingToHumanReadable(violationType) should return "Potential Recommendations"', function (ava) {
...
test('getViolationMappingToHumanReadable(violationType) should return "Manual Checks"', function (ava) {
...
test('getViolationMappingToHumanReadable(violationType) should return "UNKNOWN"', function (ava) {
