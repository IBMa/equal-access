...
describe("ACReporterSlack.parseSlackTarget", function () {
    ...
    it('parseSlackTarget(slackTarget) should return slack information object with account, token and channel', function (done) {
        ...
        expect(parsedSlackInformation).to.deep.equal(expectedSlackInformation);
        done();
    });

    it('parseSlackTarget(slackTarget) should return slack information object with account, and token', function (done) {
