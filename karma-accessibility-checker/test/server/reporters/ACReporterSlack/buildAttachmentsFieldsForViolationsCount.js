...
/*******************************************************************************
 * NAME: buildAttachmentsFieldsForViolationsCount.js
...
test('buildAttachmentsFieldsForViolationsCount(scanSummary) should return the slack notification attachment fields for violation counts when failing', function (ava) {
    ...
    ava.deepEqual(attachmentsFieldsForViolations, expectedAttachmentsFieldsForViolationsObject);
});

test('buildAttachmentsFieldsForViolationsCount(scanSummary) should return the slack notification attachment fields for violation counts when passing', function (ava) {
