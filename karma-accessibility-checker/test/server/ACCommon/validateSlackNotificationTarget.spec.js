...
/*******************************************************************************
 * NAME: validateSlackNotificationTarget.spec.js
...
describe("ACCommon.validateSlackNotificationTarget", function () {
    ...
    it('validateSlackNotificationTarget(slackTarget) should validate slack target for API token with channel provided', function (done) {
    ...
    it('validateSlackNotificationTarget(slackTarget) should validate slack target for API token without channel provided', function (done) {
    ...
    it('validateSlackNotificationTarget(slackTarget) should validate slack target for webhook', function (done) {
    ...
    it('validateSlackNotificationTarget(slackTarget) should not validate slack target for webhook', function (done) {
    ...
    it('validateSlackNotificationTarget(slackTarget) should not validate slack target for API token', function (done) {
    ...
    it('validateSlackNotificationTarget(slackTarget) should not validate slack target when an array is provided', function (done) {
