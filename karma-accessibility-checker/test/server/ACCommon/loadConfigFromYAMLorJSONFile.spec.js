...
/*******************************************************************************
 * NAME: loadConfigFromYAMLorJSONFile.spec.js
...
describe("ACCommon.loadConfigFromYAMLorJSONFile", function() {
    ...
    it('loadConfigFromYAMLorJSONFile() should load .achecker.yml and return config object', function(done) {
        ...
        expect(configObject).to.deep.equal(unitTestCommon.ACConfigMock);
        done();
    });

    it('loadConfigFromYAMLorJSONFile() should load .achecker.yaml and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load achecker.json and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load achecker.js and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load .config/.achecker.yml and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load .config/.achecker.yaml and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load .config/achecker.json and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load .config/achecker.js and return config object', function(done) {
    ...
    it('loadConfigFromYAMLorJSONFile() should load nothing and return empty config object', function(done) {
        ...
        expect(configObject).to.deep.equal({});
        done();
    });

    it('loadConfigFromYAMLorJSONFile() should load empty config and return empty config object', function(done) {
