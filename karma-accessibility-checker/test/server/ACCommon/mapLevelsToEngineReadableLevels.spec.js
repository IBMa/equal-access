...
/*******************************************************************************
 * NAME: mapLevelsToEngineReadableLevels.spec.js
...
describe("ACCommon.mapLevelsToEngineReadableLevels", function () {
    ...
    it('mapLevelsToEngineReadableLevels(levelArray) should return engine readable violation levels', function (done) {
        ...
        expect(convertedLevelArray).to.deep.equal(expectedLevelArray);
        done();
    });
