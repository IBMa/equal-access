...
describe("Rule Unit Tests As URL", function () {
    ...
    var unitTestcaseHTML = { "rulestest/2015RulesDep/g502-263/heapdump_phd_format.html": "http://pttest-data.canlab.ibm.com/acce-rules/rulestest/2015RulesDep/g502-263/heapdump_phd_format.html"};
    ...
    unitTestHTMLKeys.forEach(function(unitTestFileKey) {
        ...
        (function (unitTestFile) {
            ...
            describe("Load Test: " + unitTestFile, function () {
                ...
                it('aChecker.stringifyResults.test.js: a11y scan should match expected value', function (done) {
                    ...
                    aChecker.getCompliance(unitTestFile, unitTestFileKey, function (results) {
                        ...
                        if ( returnCode > 0) {
                            // Log the issues
                            console.log(aChecker.stringifyResults(results));
                        }
                        ...
                        expect(returnCode).toBeGreaterThan(-2, "\nDoes not match baseline" + JSON.stringify(results));
