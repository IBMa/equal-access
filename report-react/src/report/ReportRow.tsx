        ...
        return <div className="itemRow">
            <Grid role="row" aria-expanded={open} className="itemHeader" onClick={this.toggleRow.bind(this)} tabIndex={0} onKeyDown={this.onKeyDown.bind(this)}>
                <Column sm={1} md={2} lg={4} role="cell">
                    ...
                    {vCount > 0 && <><span style={{ verticalAlign: "text-top", lineHeight: "8px" }}>{vCount}</span> <span><img src={Violation16} alt="Violation"/>&nbsp;</span></>}
                    {nrCount > 0 && <><span style={{ verticalAlign: "text-top", lineHeight: "8px" }}>{nrCount}</span> <span><img src={NeedsReview16} alt="Need review"/>&nbsp;</span></>}
                    {rCount > 0 && <><span style={{ verticalAlign: "text-top", lineHeight: "8px" }}>{rCount}</span> <img src={Recommendation16} alt="Recommendation"/></>}
                </Column>
                    ...
                    return (<Grid className={"itemDetail"}>
                        ...
                        <Column sm={3} md={6} lg={8} role="cell">
                            <div className="itemMessage">
                                {val === "Violation" && <span><img src={Violation16} alt="Violation"/></span>}
                                {val === "Needs review" && <span><img src={NeedsReview16} alt="Need review"/></span>}
                                {val === "Recommendation" && <span><img src={Recommendation16} alt="Recommendation"/></span>}
