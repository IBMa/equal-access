...
!(function () {
    ...
    let metricsLogger;
    let initialize = () => {
        aChecker.DEBUG && console.log("START 'initialize' function");
        if (aChecker.Config) {
            aChecker.DEBUG && console.log("END 'initialize' function: Config already loaded");
            return typeof cy === "undefined" ? Promise.resolve() : cy.wrap({});
        }
        return ACConfigLoader()
        .then((config) => {
            aChecker.Config = config;
            ...
            metricsLogger = new ACMetricsLogger("cypress-accessibility-checker", logger, aChecker.Config.policies.join(","));
            ...
            return aChecker.loadEngine()
            .then(() => {
                aChecker.DEBUG && console.log("END 'initialize' function");
            })
        });
    }
     ...
     */
    aChecker.loadEngine = function (content) {
        aChecker.DEBUG && console.log("START 'aChecker.loadEngine' function");
        ...
        .then((win) => {
            ...
            if (!myWindow.ace) {
                ...
                .then(() => {
                    ...
                    aChecker.DEBUG && console.log("END 'aChecker.loadEngine' function");
                })
            } else {
                win.ace = myWindow.ace;
                aChecker.DEBUG && console.log("END 'aChecker.loadEngine' function");
     ...
     * @memberOf this
     */
    aChecker.sendResultsToReporter = async function (unFilteredResults, results, profile) {
...
module.exports = {
    ...
    sendResultsToReporter: aChecker.sendResultsToReporter
}