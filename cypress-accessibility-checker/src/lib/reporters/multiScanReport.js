...
let createReportWorkbook = (storedScans, scanType, storedScanCount, archives, toolID) => {
    // create workbook
    // @ts-ignore
    const workbook = new ExcelJS.Workbook({ useStyles: true });

    // create worksheets
    createOverviewSheet(storedScans, scanType, storedScanCount, archives, workbook, toolID);
    createScanSummarySheet(storedScans, scanType, workbook);
    createIssueSummarySheet(storedScans, scanType, workbook);
    createIssuesSheet(storedScans, scanType, workbook);
    createDefinitionsSheet(workbook);
    return workbook;
}

function createOverviewSheet(storedScans, scanType, storedScanCount, archives, workbook, toolID) {
...
function createScanSummarySheet(storedScans, scanType, workbook) {
...
function createIssueSummarySheet(storedScans, scanType, workbook) {
    ...
    // @ts-ignore
    let level1VrowValues = countDuplicatesInArray(level1V); // note this returns an object
    // @ts-ignore
    let level1NRrowValues = countDuplicatesInArray(level1NR);
    // @ts-ignore
    let level1RrowValues = countDuplicatesInArray(level1R);

    // @ts-ignore
    let level2VrowValues = countDuplicatesInArray(level2V); // note this returns an object
    // @ts-ignore
    let level2NRrowValues = countDuplicatesInArray(level2NR);
    // @ts-ignore
    let level2RrowValues = countDuplicatesInArray(level2R);

    // @ts-ignore
    let level3VrowValues = countDuplicatesInArray(level3V); // note this returns an object
    // @ts-ignore
    let level3NRrowValues = countDuplicatesInArray(level3NR);
    // @ts-ignore
    let level3RrowValues = countDuplicatesInArray(level3R);

    // @ts-ignore
    let level4VrowValues = countDuplicatesInArray(level4V); // note this returns an object
    // @ts-ignore
    let level4NRrowValues = countDuplicatesInArray(level4NR);
    // @ts-ignore
    let level4RrowValues = countDuplicatesInArray(level4R);
...
function createIssuesSheet(storedScans, scanType, workbook) {
...
function createDefinitionsSheet(workbook) {
...
function countDuplicatesInArray(array) {
    let count = {};
    // let result = [];
