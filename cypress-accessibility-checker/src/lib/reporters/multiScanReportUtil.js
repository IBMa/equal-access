...
let download_file = (download_file_blob, download_file_name) => {
...
let  single_page_report_file_name = (tab_title) => {
...
module.exports = {download_file, single_page_report_file_name };
