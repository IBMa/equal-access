...
var skipList = [
    ...
    //deprecated
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_fail1.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_fail2.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_inapplicable1.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_inapplicable2.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_inapplicable3.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "act_inapplicable4.html"),
    ...
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "element_too_small1.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "element_too_small2.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "scrollable_element_tabbable.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "textarea_pass.html"),
    path.join(process.cwd(), "..", "accessibility-checker-engine", "test", "v2", "checker", "accessibility", "rules", "element_scrollable_tabbable_ruleunit", "textarea_pass2.html"),
