...
This boilerplate demonstrates how to integrate IBM's Accessibility Checker with a [Mocha](https://www.npmjs.com/package/mocha) test framework using [Selenium WebDriver](https://www.npmjs.com/package/selenium-webdriver) for browser automation.
...
This boilerplate extends a standard [Mocha](https://www.npmjs.com/package/mocha) and [Selenium WebDriver](https://www.npmjs.com/package/selenium-webdriver) setup with:
...
- `test/`: Test files using [Mocha](https://www.npmjs.com/package/mocha) and [Selenium WebDriver](https://www.npmjs.com/package/selenium-webdriver)
