...
### The `'role'` defined with the element is not valid per the ARIA specification

<div id="locLevel"></div>

Elements must have a valid `'role'` per the ARIA specification
