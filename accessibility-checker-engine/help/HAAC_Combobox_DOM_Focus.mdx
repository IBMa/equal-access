...
### Initial DOM focus is not correctly set with the combobox

<div id="locLevel"></div>

Initial DOM focus with the combobox must be set with the `<text>` input
