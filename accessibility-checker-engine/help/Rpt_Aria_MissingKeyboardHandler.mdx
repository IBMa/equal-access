...
[IBM 2.1.1 Keyboard](http://www.ibm.com/able/guidelines/ci162/keyboard.html) | [WAI-ARIA Authoring Practices 1.1, Design Patterns and Widgets](https://www.w3.org/TR/wai-aria-practices-1.1/#aria_ex) | [W3C WAI-ARIA 1.1, Developing a Keyboard Interface](https://www.w3.org/TR/wai-aria-practices-1.1/#keyboard)
 ...
 * OR, if the component is not keyboard accessible, implement `onkeydown` or `onkeypress` keyboard handlers on the element itself using the [ARIA Authoring practices guidance](https://www.w3.org/TR/wai-aria-practices-1.1/);
 ...
 * OR, use other methods to provide keyboard access as described in [WAI-ARIA Authoring Practices 1.1, Design Patterns and Widgets](https://www.w3.org/TR/wai-aria-practices-1.1/#aria_ex), using the [WAI-ARIA 1.1 Authoring practices guidance](https://www.w3.org/TR/wai-aria-practices-1.1/)
