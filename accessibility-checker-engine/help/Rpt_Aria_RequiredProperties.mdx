...
### An element with ARIA role does not have the required ARIA attribute

<div id="locLevel"></div>

When using a ARIA role on an element, the required attributes for that role must be defined
