...
### The value specified for the attribute with the element is not valid

<div id="locLevel"></div>

The attribute value specified with the element must be valid per ARIA specification
...
* Provide a valid value for the attribute defined with the element, using the ARIA specification as a guide.
