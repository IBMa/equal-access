...
* **Or**, if adjacent links have different targets but the same text, change the link text or the `alt` attribute with the image to distinguish the purpose of each link;
