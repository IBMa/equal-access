...
The 'skip to main link' or an element with the `"main"` role allows users to skip over content that is repeated on several pages. Bypassing repeated content such as banners and navigation menus allow people who use only a keyboard to quickly navigate to the main content.
