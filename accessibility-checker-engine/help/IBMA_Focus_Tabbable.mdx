...
### The component does not have a tabable element

<div id="locLevel"></div>

The component must have at least one tabable element
...
Use the HTML tabindex attribute to include the component in the tab sequence.  (Refer to the [WAI-ARIA practices](https://w3c.github.io/aria-practices/#keyboard) for more information on how to manage keyboard focus.)
