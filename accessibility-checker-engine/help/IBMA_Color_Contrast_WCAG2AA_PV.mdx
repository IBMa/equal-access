...
## Verify that image layers between the foreground and background or color gradients do not reduce the text contrast (calculated at {0}) below WCAG 2.1 AA requirements for text of size {1}px and weight of {2}
