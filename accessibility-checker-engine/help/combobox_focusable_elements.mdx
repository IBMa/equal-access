...
### Tabable focus is not set correctly within the combobox or related popup

<div id="locLevel"></div>

Tabable focus for the combobox must be allowable only on the text input, except when using a dialog popup
