...
### The component has more than one tabable element

<div id="locLevel"></div>

The component must have no more than one tabable element
...
### What to do
* Modify the widget’s keyboard navigation model to contain only one tab stop to set focus in or on the widget. (Refer to the [ARIA practices](https://w3c.github.io/aria-practices/#keyboard) for more information on how to manage keyboard focus.)
...
[The Tab Sequence](https://w3c.github.io/aria-practices/#kbd_general_between)
