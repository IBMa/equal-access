...
* OR, uses a server-side script (specified in the action attribute) that redirects the user to the requested page (see Example 2 in [WCAG technique H32](https://www.w3.org/WAI/WCAG21/Techniques/html/H32).)
...
[WCAG technique G80](https://www.w3.org/WAI/WCAG21/Techniques/html/H32)
