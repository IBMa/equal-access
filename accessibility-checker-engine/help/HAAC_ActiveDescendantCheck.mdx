...
* **And**, verify that the child element is either a descendant of this element, or is owned by this element (indicated by using the aria-owns attribute with this element).
