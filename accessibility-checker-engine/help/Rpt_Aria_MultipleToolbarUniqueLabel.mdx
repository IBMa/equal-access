...
[IBM 4.1.2 Name, Role, Value](http://www.ibm.com/able/guidelines/ci162/name_role_value.html) | [W3C WAI-ARIA 1.1 technique ARIA16](http://www.w3.org/TR/WCAG20-TECHS/ARIA16)
...
* For each element with a `"toolbar"` role, either set the value of the `aria-labelledby` attribute to the `id` of any visible text that appropriately and uniquely describes that toolbar's purpose;
