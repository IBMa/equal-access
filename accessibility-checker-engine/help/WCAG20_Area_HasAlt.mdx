...
Note: Example code includes material copied from or derived from [WCAG technique H24](https://www.w3.org/TR/WCAG20-TECHS/H24) Copyright © [2013-2017] W3C® (MIT, ERCIM, Keio, Beihang).
...
* [WCAG technique H24](https://www.w3.org/TR/WCAG20-TECHS/H24)
