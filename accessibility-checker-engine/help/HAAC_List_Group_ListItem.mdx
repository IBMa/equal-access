...
### Why is this important?
 ...
 When `role="group"` is used with a list component, authors must limit the group element's children to elements with an implied or explicit role of `"listitem"`. This facilitates proper handling of the group’s context by user agents and assistive technology.
 ...
 * **Or**, use the attribute `role="listitem"` with all children of the element with `role="group"`.
