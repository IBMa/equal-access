 ...
 * Set the value of the `'tabindex'` attribute equal to 0 or -1 with the element using `'aria-activedescendant'` property to include the element in the tab sequence. 
