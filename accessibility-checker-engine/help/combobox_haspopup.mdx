...
The value of the combobox `aria-haspopup` attribute must be valid and match the `role` value of the popup element
...
attribute, people who use assistive technologies may may see unexpected behavior and will not know how 
