...
* **Or**, update the attributes with the element using the guidance in the [Document conformance requirements for use of "ARIA" attributes in HTML](https://www.w3.org/TR/html-aria/#docconformance) section of 
the ARIA in HTML specification. 
This reference provides details of valid ARIA markup with native HTML elements.
