...
module.exports = (config) => {
    config.set({
        ...
        files: [
            ...
            //{ pattern: 'test/v2/checker/accessibility/rules/ACT_Meta_Viewport_ruleunit/viewport_pass_enough_maxium_user_scale.html', watched: true },
            //{ pattern: 'test/v2/checker/accessibility/rules/ACT_Meta_Viewport_ruleunit/viewport_pass_ignored_maximum_user_scale.html', watched: true },
            //{ pattern: 'test/v2/checker/accessibility/rules/ACT_Meta_Viewport_ruleunit/viewport_fail_unknown_maximum_user_scale.html', watched: true },
            //{ pattern: 'test/v2/checker/accessibility/rules/ACT_Meta_Viewport_ruleunit/viewport_pass_no_content.html', watched: true },
            //{ pattern: 'test/v2/checker/accessibility/rules/ACT_Meta_Viewport_ruleunit/viewport_pass_no_user_scale.html', watched: true },
