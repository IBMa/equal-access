...
module.exports = (config) => {
    config.set({
        ...
        files: [
            ...
            { pattern: 'test/v2/checker/accessibility/rules/element_orientation_unlocked_ruleunit/act-pass1.html', watched: true },
            //{ pattern: 'test/v2/checker/accessibility/rules/element_orientation_unlocked_ruleunit/act-*.html', watched: true },
