...
let a11yNls = {
    ...
    "input_haspopup_invalid": {
        ...
        "Failure_1": "<input> element with 'list' attribute also uses 'aria-haspopup' attribute on type=\"{0}\"",
        "Failure_2": "<input> element with 'list' attribute also uses 'aria-haspopup' attribute on missing or invalid input type"
    },
    // JCH - DONE
