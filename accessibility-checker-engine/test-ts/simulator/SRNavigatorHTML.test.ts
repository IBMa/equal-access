...
`;
    ...
    it("Sim Test", function () {
        ...
        expect(ace.SRController.renderAll("link")).toEqual([
            "[list of 3 items] [same page link] HTML Elements (without roles)",
            "[same page link] ARIA Roles",
            "[same page link] ARIA Attributes",
            "[out of list] [navigation region] [list of 2 items] [same page link] Navigation Link 1",
        ...
        expect(ace.SRController.renderAll("tab_focus")).toEqual([
            ...
            "[out of grouping] [list of 2 items] Menu Item 1 [button]",
            "Menu Item 2 [button]"
        ]);
