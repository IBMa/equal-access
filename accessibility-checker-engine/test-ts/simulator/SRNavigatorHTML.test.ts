...
`;
    ...
    it("Sim Test", function () {
        ...
        const expectedResult = [
            ...
            "[list of 3 items] [bullet] [same page link] HTML Elements (without roles)",
            ...
            "Example of ",
            "[main region] :",
            "[main region] This is the main content area",
            "[out of main region] [out of main region] [heading level 3] Content Sectioning",
            " Example Company",
            " 123 Street Name",
            " City, Country ",
            ...
            "[navigation region] [list of 2 items] [bullet] [same page link] Navigation Link 1",
            "[bullet] [same page link] Navigation Link 2",
            "[out of list] [out of navigation region] [heading level 4] Section Example",
            ...
            "[definition list of 2 terms] Term 1",
            "Definition 1",
            "Term 2",
            "Definition 2",
            "[out of definition list] [caption] This is a figure caption.",
            ...
            " Your browser does not support the video element. ",
            "Map with area:",
            "[image map] [same page link] Clickable area", // [graphic] ?
            ...
            "[Unlabeled graphic]",
            "MathML:",
            "x = [fraction] − b ± [square root] b [squared] − 4 a c [end root] [over] 2 a [end fraction] [math content]",
            ...
            "[list of 2 items] [bullet] Menu Item 1 [button]",
            "[bullet] Menu Item 2 [button]",
        ...
        expect(ace.SRController.renderAll("heading")).toEqual([
            "HTML Elements and ARIA Roles/Attributes Examples [heading level 1]",
            "Table of Contents [heading level 2]",
            "HTML Elements (without roles) [heading level 2]",
            "Document Structure [heading level 3]",
            "Content Sectioning [heading level 3]",
            "Article Example [heading level 4]",
            "Aside Example [heading level 4]",
            ...
            "Section Example [heading level 4]",
            "Text Content [heading level 3]",
            "Inline Text Semantics [heading level 3]",
            "Image and Multimedia [heading level 3]",
            "Embedded Content [heading level 3]",
            "SVG and MathML [heading level 3]",
            "Scripting [heading level 3]",
            "Demarcating Edits [heading level 3]",
            "Table Content [heading level 3]",
            "Forms [heading level 3]",
            "Interactive Elements [heading level 3]",
            "Web Components [heading level 3]"
        ]);
        expect(ace.SRController.renderAll("link")).toEqual([
            "[same page link] HTML Elements (without roles)",
            "[same page link] ARIA Roles",
            "[same page link] ARIA Attributes",
            "[same page link] Navigation Link 1",
