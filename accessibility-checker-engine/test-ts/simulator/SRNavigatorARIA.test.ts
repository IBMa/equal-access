...
`;
    ...
    it("Sim Test", function () {
        ...
        const expectedResult = [
            ...
            "[list of 5 items] [bullet] [same page link] Introduction to ARIA",
            ...
            "The following examples demonstrate proper implementation of common UI patterns using ARIA roles, states, and properties according to the ",
            "[link] ARIA Authoring Practices Guide",
            ".",
            "[heading level 3] Accordion",
            "[heading level 3] Section 1 [button, expanded]",
            "Section 1 [region] Content for section 1. This section is expanded by default.",
            "[out of region] [heading level 3] Section 2 [button, collapsed]",
            ...
            "Menu Button [menu button, collapsed] [subMenu]",
            "[heading level 3] Combobox",
            "Choose an option:",
            "[combo box, collapsed, has auto complete, editable, opens list] show options [button]",
