...
public class SomeClassSeleniumTest {
    ...
    @BeforeClass public static void setup() {
        ...
        try {
            SomeClassSeleniumTest.driver = new ChromeDriver(options);
    ...
    @AfterClass public static void teardown() {
        SomeClassSeleniumTest.driver.close();
        AccessibilityChecker.close();
    }

    @Test public void getCompliance() {
        SomeClassSeleniumTest.driver.get("https://altoromutual.12mc9fdq8fib.us-south.codeengine.appdomain.cloud/");
